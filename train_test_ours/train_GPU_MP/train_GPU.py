...
dry_run_iterations = 2 # If dry run flag is set TRUE the code will terminate after these many iterations
...
os.environ["CUDA_VISIBLE_DEVICES"]="0" #'0'# You would probably like to change it to 0 or some other integer depending on GPU avalability.
